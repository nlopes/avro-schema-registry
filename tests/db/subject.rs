...
use avro_schema_registry::db::models::{RegisterSchema, Schema};
...
pub fn register_schema(conn: &super::PgConnection, subject: String, schema: String) -> Schema {
    Schema::register_new_version(conn, RegisterSchema { subject, schema }).unwrap()
}
